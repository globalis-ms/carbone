...
define('STR_CONNECT',   'connected user%s');
...
define('STR_FORM_LEGENDE', 'Mandatory fields '.STR_FORM_REQUIRE_SYMBOL);
...
// Upload
//
define('STR_UPLOAD_SEND',              'Send');
define('STR_UPLOAD_MULTIPLE_DRAG',     'Drop or select files');
define('STR_UPLOAD_MULTIPLE_NODRAG',   'Select files');
define('STR_UPLOAD_MULTIPLE_SELECTED', '%d selected files'); // Remplacé via String.replace en js, pas un sprintf
define('STR_UPLOAD_SINGLE_DRAG',       'Drop or select a file');
define('STR_UPLOAD_SINGLE_NODRAG',     'Select a file');
define('STR_UPLOAD_SINGLE_SELECTED',   'File selected');
...
define('STR_UTILISATEUR_FIELDSET_THEME', 'Change theme and language');
define('STR_UTILISATEUR_LEGENDE_PASSWORD', 'Saisissez le mot de passe.');
define('STR_UTILISATEUR_LEGENDE_PASSWORD_MODIF', 'If you want to change the password, enter a new one twice. Otherwise, leave the field blank.');
define('STR_UTILISATEUR_LEGENDE_PASSWORD_CONFIRMATION', 'Please confirm password');
...
define('STR_UTILISATEUR_E_INFO_1', 'L\'ajout a été effectuée !');
...
define('STR_PROFIL_TITRE', 'Manage my profil');
