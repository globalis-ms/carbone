...
define ('CFG_VERSION', '5.3.001');                                          // Version de l'application
define ('CFG_VERSION_CARBONE', '5.3.001 Pluton');                                  // Version de Carbone
define ('CFG_DATE', '03/07/2015');                                          // Date de dernières révision de l'application
